...
Engines (installed, not daemons): Scrapy, Playwright/Chromium, Java/Tika under `/opt/flahaintel/runtimes`. Never five persistent worker loops. Docling is not installed.
