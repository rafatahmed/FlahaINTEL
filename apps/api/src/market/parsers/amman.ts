 ...
 */
import { resolveJoAmmanNames } from "../joAmmanCommodityMap.js";
...
export function mapAmmanRow(raw: AmmanRawRow): PriceRowInput {
  ...
  const resolved = resolveJoAmmanNames({
    commodityNameAr: nameAr || null,
    commodityNameEn: raw.commodityNameEn,
  ...
  return {
    observedOn,
    commodityName: resolved.displayName,
    commodityNameEn: resolved.commodityNameEn,
    commodityNameAr: resolved.commodityNameAr,
    commodityCode: resolved.commodityCode || undefined,
